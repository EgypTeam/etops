...
export ETOPS_COMMAND=$(basename $BASH_SOURCE)
export ETOPS_COMMAND_ABSOLUTE_PATH=$(realpath $READ_LINK)
export ETOPS_COMMAND_REAL=$(basename $ETOPS_COMMAND_ABSOLUTE_PATH)
#echo $ETOPS_COMMAND
